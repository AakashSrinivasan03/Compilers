/* Generated By:JavaCC: Do not edit this line. MiniExpr.java */
import syntaxtree.*;
import java.util.Vector;


public class MiniExpr implements MiniExprConstants {
  ...
  static final public PrintStatment PrintStatment() throws ParseException {
   ...
   Expression n2;
    ...
    n2 = Expression();
     {if (true) return new PrintStatment(n0,n2);}
    throw new Error("Missing return statement in function");
  }
  ...
  static public MiniExprTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x140800,0x140800,0x140800,0x180200,0x180200,};
   }
  ...
  public MiniExpr(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public MiniExpr(java.io.InputStream stream, String encoding) {
    ...
    token_source = new MiniExprTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public MiniExpr(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public MiniExpr(MiniExprTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(MiniExprTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
