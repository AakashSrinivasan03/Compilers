...
/**
    ...
    */
    ...
    if(count==2)
     ...
     s.add(temp_Symboltable);
      ...
      else if(temp_Minfo.ret_type.ctype.name!=s4)
         {System.out.println("Type error");System.exit(0);}
   ...
   public R visit(MessageSend n, A argu) {  ///////////////////check for matching!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      n.f1.accept(this, argu);
        	...
        	{System.out.println("Symbol not found");System.exit(0);}
               ...
               {     
               	 ...
               	 parent.methods.get(idx1).list_counter=0;  
               	  parent.methods.get(idx1).max_counter=parent.methods.get(idx1).arg_name.size();
                n.f4.accept(this, (A)parent.methods.get(idx1));
                 if(parent.methods.get(idx1).list_counter!=parent.methods.get(idx1).max_counter)
                 	{System.out.println((parent.methods.get(idx1).list_counter));System.out.println("Type error4");System.exit(0);}
                 parent.methods.get(idx1).list_counter=0;
                 parent.methods.get(idx1).max_counter=0;
                 n.f5.accept(this, argu);
        ...
        if(idx1==-1)
        	{System.out.println("Symbol not found3");System.exit(0);}
   ...
   public R visit(ExpressionList n, A argu) {
      R _ret=null;
      if(count!=2 || ((Minfo)argu).max_counter==0)
      {n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      }
      else
      {String s1=n.f0.accept(this, argu).toString();
         if(((Minfo)argu).list_counter>=((Minfo)argu).max_counter){System.out.println("Type error");System.exit(0);}
         if(s1=="int"||s1=="boolean"||s1=="int[]")
         { if(s1!=((Minfo)argu).arg_type.get(((Minfo)argu).list_counter).tname)
          ...
          {  if(s1!=((Minfo)argu).arg_type.get(((Minfo)argu).list_counter).ctype.name) ////////////////////////////////type check/////////////////////////////////
             {System.out.println("Type error");System.exit(0);}

          }
            //System.out.println(list_counter);
          ((Minfo)argu).list_counter=((Minfo)argu).list_counter+1;
          //System.out.println(list_counter);
      n.f1.accept(this, argu);
      }
      return _ret;
   ...
   public R visit(ExpressionRest n, A argu) {
      ...
      {  n.f0.accept(this, argu);
         ...
         if(s1=="int"||s1=="boolean"||s1=="int[]")
         { if(s1!=((Minfo)argu).arg_type.get(((Minfo)argu).list_counter).tname)
             {System.out.println("Type error3");System.exit(0);}

         }
          else
          {  if(s1!=((Minfo)argu).arg_type.get(((Minfo)argu).list_counter).ctype.name)
             {System.out.println("Type error3");System.exit(0);}
