...
/**
        ...
        Classtype parent=class_var.get(idx);
         ...
         n.f4.accept(this, argu);
          if(parent.methods.get(idx1).arg_type.size()!=parent.methods.get(idx1).list_counter)
             {list_counter=0;System.out.println("Type error1111");System.exit(0);}
             parent.methods.get(idx1).list_counter=0;
          //  list_counter=0;
      //    if(m1.max_counter!=m1.list_counter )
        //{System.out.println("Type error111");System.exit(0);}
   ...
   public R visit(ExpressionList n, A argu) {
      ...
      if(m1.max_counter==0)
        {System.out.println("Type error11");System.exit(0);}
      String s1=n.f0.accept(this, argu).toString();
       if(s1=="int"||s1=="boolean"||s1=="int[]")
         { if(s1!=m1.arg_type.get(m1.list_counter).tname)
             {System.out.println(m1.list_counter);System.out.println(m1.arg_type.get(m1.list_counter).tname); System.out.println("Type error2");System.exit(0);}

         }
          else
          {  if(match(m1.arg_type.get(m1.list_counter).ctype.name,s1)) ////////////////////////////////type check/////////////////////////////////
             {System.out.println("Type error3");System.out.println(s1);System.exit(0);}
   ...
   public R visit(ExpressionRest n, A argu) {
      ...
      String s1=n.f1.accept(this, argu).toString();
       if(s1=="int"||s1=="boolean"||s1=="int[]")
         { if(s1!=m1.arg_type.get(m1.list_counter).tname)
             {/*System.out.println(list_counter);System.out.println(((Minfo)argu).arg_type.get(list_counter).tname);*/ System.out.println("Type error2");System.exit(0);}
